...
HD_PWD='/home/dan/src/mlperf-tiny-ebaz4205/hw/build-dirty/ebaz4205_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz4205_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz4205_top.tcl
