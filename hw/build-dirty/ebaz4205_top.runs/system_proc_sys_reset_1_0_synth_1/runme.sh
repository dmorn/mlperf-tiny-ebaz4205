...
HD_PWD='/home/dan/src/mlperf-tiny-ebaz4205/hw/build-dirty/ebaz4205_top.runs/system_proc_sys_reset_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_proc_sys_reset_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_proc_sys_reset_1_0.tcl
